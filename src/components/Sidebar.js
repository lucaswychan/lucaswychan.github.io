...
function Sidebar({ skills, links, photoUrl, activeSection, handleSectionClick, toggleMusicPlayer, showMusicPlayer }) {
    ...
    return (
        <aside className="h-100 p-4 d-flex flex-column">
            <div className="flex-grow-1">
                {/* Profile Photo */}
                <div className="text-center mb-3">
                    <div
                        className="mx-auto profile-photo-container"
                    ...
                    <ul className="nav flex-column navigation-menu">
                        {[
                            ...
                            <li className="nav-item" key={section}>
                                <button
                                    className={`nav-link cursor-pointer border-0 bg-transparent text-start w-100 d-flex align-items-center ${
                                ...
                                >
                                    <span
                                        className="nav-icon-container me-3"
                                        style={{
                                            display: "flex",
                                            alignItems: "center",
                                            justifyContent: "center",
                        ...
                        <div className="mb-4">
                            {skills.skills.map(
                                (skillCategory, categoryIndex) => (
                                    ...
                                    >
                                        <h4
                                            className="small fw-medium mb-3 ps-3"
                                            style={{
